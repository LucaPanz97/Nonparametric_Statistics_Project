...
#decido di usare solo bathrooms
...
# Variabili da usare nell'outliers detection: log10(price), bedrooms, bathrooms, log10(sqm_living), log10(sqm_lot), geodist_index

x11()
aplpack::bagplot(DATA[c("bedrooms","log10(price)")],xlab="bedrooms",ylab="log10(price)")
bagplot_cont_normals_bedrooms <- bagplot(DATA[c("bedrooms","log10(price)")])
outlying_obs_bedrooms <- bagplot_cont_normals_bedrooms$pxy.outlier

x11()
aplpack::bagplot(DATA[c("bathrooms","log10(price)")],xlab="bathrooms",ylab="log10(price)")
bagplot_cont_normals_bathrooms <- bagplot(DATA[c("bathrooms","log10(price)")])
outlying_obs_bathrooms <- bagplot_cont_normals_bathrooms$pxy.outlier

x11()
aplpack::bagplot(DATA[c("Log_sqm_living","log10(price)")],xlab="Log_sqm_living",ylab="log10(price)")
bagplot_cont_normals_log10sqmliving <- bagplot(DATA[c("Log_sqm_living","log10(price)")])
outlying_obs_log10sqmliving <- bagplot_cont_normals_log10sqmliving$pxy.outlier

x11()
aplpack::bagplot(DATA[c("Log_sqm_lot","log10(price)")],xlab="Log_sqm_lot",ylab="log10(price)")
bagplot_cont_normals_log10sqmlot <- bagplot(DATA[c("Log_sqm_lot","log10(price)")])
outlying_obs_log10sqmlot <- bagplot_cont_normals_log10sqmlot$pxy.outlier

x11()
aplpack::bagplot(DATA[c("Log_sqm_living15","log10(price)")],xlab="Log_sqm_living15",ylab="log10(price)")
bagplot_cont_normals_log10sqmliving15 <- bagplot(DATA[c("Log_sqm_living15","log10(price)")])
outlying_obs_log10sqmliving15 <- bagplot_cont_normals_log10sqmliving15$pxy.outlier

x11()
aplpack::bagplot(DATA[c("geodist_index","log10(price)")],xlab="geodist_index",ylab="log10(price)")
bagplot_cont_normals_geodistindex <- bagplot(DATA[c("geodist_index","log10(price)")])
